...
//
//     // POST, PATCH, PUT
//     send(verb: string, requestUrl: string, objs: any, headers: ifm.IHeaders, onResult: (err: any, res: http.IncomingMessage, contents: string) => void): void {
//         var options = this._getOptions(verb, requestUrl, headers);
//         this.request(options.protocol, options.options, objs, onResult);
//     }
//
//     sendFile(verb: string, requestUrl: string, content: NodeJS.ReadableStream, headers: ifm.IHeaders, onResult: (err: any, res: http.IncomingMessage, contents: string) => void): void {
//         var options = this._getOptions(verb, requestUrl, headers);
//
...
//     }
//
//     request(protocol: any, options: any, objs: any, onResult: (err: any, res: http.IncomingMessage, contents: string) => void): void {
//         var reqData;
//         var socket;
//
//         if (objs) {
