...
export interface ICoreApi extends basem.ClientApiBase
{
	...
	getTeams(projectId: string, teamId: string, top: number, skip: number, onResult: (err: any, statusCode: number, team: { count: number, value: Array<CoreInterfaces.WebApiTeam>}) => void): void;
}
...
export interface IQCoreApi extends basem.QClientApiBase
{
	...
	getTeams(projectId: string, teamId?: string, top?: number, skip?: number): Q.Promise<{ count: number, value: Array<CoreInterfaces.WebApiTeam>}>;
}
...
export class CoreApi extends basem.ClientApiBase implements ICoreApi
{
	...
	public getTeams(
		...
		top: number,
		skip: number,
		onResult: (err: any, statusCode: number, team: { count: number, value: Array<CoreInterfaces.WebApiTeam>}) => void
	): void
	{
...
export class QCoreApi extends basem.QClientApiBase implements IQCoreApi
{
	...
	public getTeams(
		...
		top?: number,
		skip?: number
	): Q.Promise<{ count: number, value: Array<CoreInterfaces.WebApiTeam>}>
	{

		var deferred = Q.defer<{ count: number, value: Array<CoreInterfaces.WebApiTeam>}>();

		this.api.getTeams(projectId, teamId, top, skip, (err: any, statusCode: number, team: { count: number, value: Array<CoreInterfaces.WebApiTeam>}) => {
			if (err) {
				err.statusCode = statusCode;
				deferred.reject(err);
			} else {
		...
		return <Q.Promise<{ count: number, value: Array<CoreInterfaces.WebApiTeam>}>>deferred.promise;
	}
