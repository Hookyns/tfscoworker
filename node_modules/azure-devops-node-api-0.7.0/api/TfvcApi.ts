...
import {getStream} from './RestClient';
...
export class TfvcApi extends basem.ClientApiBase implements ITfvcApi {
    ...
    public getItemsBatchZip(
        ...
        .then((versioningData: vsom.ClientVersioningData) => {
            ...
            getStream(this.httpClient, url, apiVersion, "application/zip", onResult);
        })
        .fail((error) => {
            onResult(error, error.statusCode, null);
        });
    ...
    public getItemContent(
        ...
        .then((versioningData: vsom.ClientVersioningData) => {
            ...
            getStream(this.httpClient, url, apiVersion, "application/octet-stream", onResult);
        })
        .fail((error) => {
            onResult(error, error.statusCode, null);
        });
    ...
    public getItemText(
        ...
        .then((versioningData: vsom.ClientVersioningData) => {
            ...
            getStream(this.httpClient, url, apiVersion, "text/plain", onResult);
        })
        .fail((error) => {
            onResult(error, error.statusCode, null);
        });
