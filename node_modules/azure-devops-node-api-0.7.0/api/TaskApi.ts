...
import {makeAcceptHeader, getStream} from './RestClient';
...
export class TaskApi extends basem.ClientApiBase implements ITaskApi {
    ...
    public async getAttachmentContent(
        ...
        this.vsoClient.getVersioningData("2.2-preview.1", "distributedtask", "7898f959-9cdf-4096-b29e-7f293031629e", routeValues)
        .then(async (versioningData: vsom.ClientVersioningData) => {
            var url: string = versioningData.requestUrl;
            var apiVersion: string = versioningData.apiVersion;
			...
			// try {
			// 	let res = await this.httpClient.get(url, {"Accept": accept});
